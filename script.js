...
// Obtenha matrizes do localStorage se disponível, defina valores padrão se não
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Terminar Cursos', 'Terminar pós-graduação'];
    progressListArray = ['Cursos', 'pós'];
    completeListArray = [''];
    onHoldListArray = ['Provas'];
  }
}
